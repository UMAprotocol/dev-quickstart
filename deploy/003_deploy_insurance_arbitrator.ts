...
const func = async function (hre: HardhatRuntimeEnvironment) {
  ...
  // Note: For Goerli insurance currency by default is set to hardcoded TestnetERC20 that is mintable by anyone and
  ...
  await deploy("InsuranceArbitrator", {
    from: deployer,
    args: [Finder, Currency, ZERO_ADDRESS],
    log: true,
    skipIfAlreadyDeployed: false,
  });
};
module.exports = func;
func.tags = ["InsuranceArbitrator"];
